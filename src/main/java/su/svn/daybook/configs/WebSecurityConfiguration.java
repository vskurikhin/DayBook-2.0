...
public class WebSecurityConfiguration {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .pathMatchers(HttpMethod.GET, "/api/v1/news-group/all").permitAll()
                .pathMatchers(HttpMethod.GET, "/api/v1/news-group/like").permitAll()
                .pathMatchers(HttpMethod.GET, "/api/v1/news-group/page").permitAll()
